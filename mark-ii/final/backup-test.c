...
sprintf(bufferWrite, "%d,%d,%d,%d,%d,%d,",(dataOut1)+10000,(dataOut2)+20000,(dataOut3)+3000,(dataOut4)+4000,(dataOut5)+5000,(dataOut6)+6000);
...
int main(){
	...
	serialStart("/dev/ttyACM0", B115200, 32);	
	    while(1) {
	...
	serialWrite(intscan1, intscan2, intscan3, intscan4, intscan5, intscan6 ,32);

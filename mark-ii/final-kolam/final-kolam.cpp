...
void belokKiri(){
  ...
  kiriBelok 	= 70; // 5 maju ; 70 kiri mundur
...
//		 usleep(185000);
       ...
       printf("Throttle : %s %d %f %d %d %d %d %d %d\n",movementStat, r, pid,  motorKiri, motorKanan,kiriMundur, kiriBelok, kananMundur, kananBelok);

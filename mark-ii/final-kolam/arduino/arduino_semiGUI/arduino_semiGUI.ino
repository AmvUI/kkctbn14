...
void loop(){
  if(Serial.available()>0)
    ...
    Serial.print("  ");
    if(leftMotor < 1000 ){ Serial.print(" ");
      if(leftMotor < 100 ){ Serial.print(" ");
        if(leftMotor < 10 ){ Serial.print(" ");}
      }
    }
    Serial.print( leftMotor);
    
    Serial.print("  ");
    if(rightMotor < 1000 ){ Serial.print(" ");
      if(rightMotor < 100 ){ Serial.print(" ");
        if(rightMotor < 10 ){ Serial.print(" ");}
      }
    }
    Serial.print( rightMotor );
    
    Serial.print("  ");
    if(servoKiriM < 100 ){ Serial.print(" ");      
      if(servoKiriM < 10 ){ Serial.print(" ");}
    }
    Serial.print( servoKiriM );
    
    Serial.print("  ");
    if(servoKiriB < 100 ){ Serial.print(" ");
      if(servoKiriB < 10 ){ Serial.print(" ");}    
    }
    Serial.print( servoKiriB );
    
    Serial.print("  ");
    if(servoKananM < 100 ){ Serial.print(" ");
      if(servoKananM < 10 ){ Serial.print(" ");}
    }    
    Serial.print( servoKananM );
    
    Serial.print("  ");
    if(servoKananB < 100 ){ Serial.print(" ");
      if(servoKananB < 10 ){ Serial.print(" ");}
    }
    Serial.print( servoKananB );

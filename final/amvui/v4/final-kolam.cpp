...
int              last_known_x   = 520; // last known position of the target.
int		 x	=	520;
...
int              sat_level 		= 89;  //aslinya 15
int              target 		=560; // posisi target
...
static double    cp             = 1.5;
static double    ci             = 0;
static double    cd             = 0.3;
...
//  cvMoveWindow("Track", 646, 0);
  ...
  for (int n = 0;; ++n) {
	...
	cvSetImageROI(framein, cvRect(0,280, 640, 80));

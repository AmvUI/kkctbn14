...
int	    		 rightBaseSpeed = 800 ;
int	    		 leftBaseSpeed  = 800 ;
int              turnPoint      = 1200;
int              breakPoint     = 780;
...
int main()
{
  ...
  for (int n = 0;; ++n) {
	...
	cvSetImageROI(framein, cvRect(0, 0, 640, 480));
...
//		motorKanan = 0;
       ...
       printf("Throttle : %s %f %d %d %d %d\n",movementStat, pid,x,  motorKiri, motorKanan,nozzleState);

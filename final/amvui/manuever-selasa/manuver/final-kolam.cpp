...
int              last_known_x   = 540; // last known position of the target.
int		 x	=	540;
...
int              sat_level 		= 65;  //aslinya 15
int              target 		= 545; // posisi target
...
//  cvMoveWindow("Track", 646, 0);
  ...
  for (int n = 0;; ++n) {
	...
	cvSetImageROI(framein, cvRect(0,360, 640, 230));
